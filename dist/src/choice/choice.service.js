...
let ChoiceService = class ChoiceService {
    ...
    async createChoiceWithoutRelationship(createChoiceDto) {
        return this.choiceRepository.createChoiceWithoutRelationship(createChoiceDto);
    }
};
ChoiceService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(choice_repository_1.ChoiceRepository)),
    __metadata("design:paramtypes", [choice_repository_1.ChoiceRepository])
], ChoiceService);
