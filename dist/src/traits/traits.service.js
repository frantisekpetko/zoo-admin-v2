...
const trait_repository_1 = require("./trait.repository");
let TraitsService = class TraitsService {
    constructor(traitRepository) {
        this.traitRepository = traitRepository;
    }
    getTraits() {
        return this.traitRepository.getTraits();
    }
    storeInitialData(createTraitsDto) {
        return this.traitRepository.storeInitialData(createTraitsDto);
    }
};
TraitsService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(trait_repository_1.TraitRepository)),
    __metadata("design:paramtypes", [trait_repository_1.TraitRepository])
], TraitsService);
