...
], Image.prototype, "urlName", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)((type) => animal_entity_1.Animal, (animal) => animal.images, { eager: false }),
    __metadata("design:type", animal_entity_1.Animal)
], Image.prototype, "animal", void 0);
Image = __decorate([
    (0, typeorm_2.Entity)({ name: 'image' })
], Image);
exports.Image = Image;
