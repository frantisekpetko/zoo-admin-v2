...
let AnimalsController = AnimalsController_1 = class AnimalsController {
    constructor(animalsService) {
        this.animalsService = animalsService;
        this.logger = new common_2.Logger(`<${AnimalsController_1.name}>`);
    }
    create(createAnimalDto) {
        return this.animalsService.create(createAnimalDto);
    }
    async getPagesNumber(limit = 10, search) {
...
], AnimalsController.prototype, "getPagesNumber", null);
__decorate([
    (0, common_1.Get)(),
...
AnimalsController = AnimalsController_1 = __decorate([
