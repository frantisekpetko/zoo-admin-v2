...
import { Box, CardMedia, Pagination, Typography, CardActions, CardContent, Button, Grid, Card } from '@mui/material';
                                ...
                                <Grid item xs={12} sm={6} lg={4} xl={3} key={animal.id} sx={{ marginBottom: 0 }}>
                                    <CustomizedCard>
                                        ...
                                        <CardActions sx={{ marginTop: '3em' }}>
                                            <Grid container direction="row" justifyContent="center" alignContent="flex-end" alignItems="flex-end">
